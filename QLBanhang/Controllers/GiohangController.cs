...
namespace QLBanhang.Controllers
{
    public class GiohangController : Controller
    {
        ...
        public ActionResult Order (string Email, string Phone)
        {
            ...
            MailMessage mail = new MailMessage("taphoaonline24.24@gmail.com", Email, "Thông tin đơn hàng", sMsg);
            SmtpClient client = new SmtpClient("smtp.gmail.com", 587);
            client.EnableSsl = true;
            client.Credentials = new NetworkCredential("taphoaonline24.24@gmail.com", "czcyqjarbghfddrk");
